...
from asset_nav_common import dump_json, load_json, normalize_weights, pick_value, safe_div


def main():
    parser = argparse.ArgumentParser(
        description="Combine asset-NAV primary and secondary method outputs into a target-price summary."
    )
    ...
    for slot, item, default_weight in [
        ("primary", primary, 0.65),
        ("secondary", secondary, 0.35),
